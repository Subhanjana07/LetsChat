...
public class ChatPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewChat = findViewById(R.id.textViewFriendName);
        editTextMessage = findViewById(R.id.editTextNewMsg);
        fab = findViewById(R.id.fabChat);
        ...
        otherName = getIntent().getStringExtra("friendUserName");
        textViewChat.setText(otherName);

        imageViewBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ChatPageActivity.this,MainActivity.class);
                startActivity(i);
            }
        });
